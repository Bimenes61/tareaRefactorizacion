 ...
 * para la gesti�n de los datos del fichero AleatorioDep.dat
 * @author AARRMM 2013
 * @version 1-2013
 * */
public class VentanaDepart extends JFrame implements ActionListener, iventanaDepart  {
	...
	/**
	 * M�todo verporconsola
	 * Este m�todo visualiza los datos del fichero en la consola.
	 * @throws IOException
	 */
	...
	/**
	 * M�todo consultar
	 * Este m�todo consulta los datos de un departamento que se recibe como par�metro.
	 * @param dep: es el n�mero del departamento a consultar.
